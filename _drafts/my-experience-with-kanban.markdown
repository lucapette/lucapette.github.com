...
I wanted to write about Kanban for a long time. I consider sharing our views
about the way we organise processes vital to the development of the
...
more dangerously, we do things by the book since we believe there's a true
way. I believe there's no such thing as "true way" when it comes about putting
more than one brain in the same room to build something . Not to mention the
fact most books tend to generalise a lot as they want to reach a broad
audience and in many cases the result is an unusable, unapplicable set of
rules. I do not think what I am saying is controversial either. Quite the opposite:
...
great side-effect of forcing a no roles policy is that it helps forming a team
quicker and to introduce new members to an existing team. The reason is quite
obvious but hard to see: if everyone does everything people will need to talk
to each other more to get or give help about specific tasks they're trying to
accomplish. You are not creating sub-teams inside your teams, good
...
be reviewed, tested and validated in different environments. The rule I come up
...
using.  I figured out it is not really true that tooling is not that
...
to change something in our workflow, we just do and our tooling reflects
...
from whatever angle, they can even change the tool we use everyday. They own
...
the working in progress has been very challenging for me despite the
...
have learnt how to appreciate the time it gives me and my teams to look at
...
and I would not be able to explain the reasoning on my own, for my own teams.
