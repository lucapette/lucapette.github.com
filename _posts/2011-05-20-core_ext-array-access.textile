...
This extension is very simple. It works in a very simple way. The || assignment operator is widely used. It allows the get default values in a very concise way. Here there is an example of how to use the method:
