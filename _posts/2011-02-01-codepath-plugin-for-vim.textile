...
description: a brief description of my first vim plugin
keywords: lucapette, codepath, vim, plugin
category: vim
layout: blog
---
Hi everyone,
...
II Think codepath.vim is a really simple vim plugin and it is really useful for me, I hope you can use it in your vim configuration. I haven't planned new features yet but I will add the multi-codepath feature if I receive feedback on it.
